...
public class Utility {
	...
	/**
	 * Create loading dialog in center of screen, without text and prevent clicks
	 * 
	 * to get the view call: findViewById(com.iarbay.utility.R.id.loading_dialog);
	 * 
	 * @return ProgressDialog after make it visible, make sure to save it in variable 
	 * to dismiss it when needed
	 */
